      ...
      <section className="grid grid-cols-1 gap-4 lg:grid-cols-12">
        <Card className="lg:col-span-3">
          <CardHeader>
            ...
            <CardDescription>Run and tune the algorithm.</CardDescription>
          </CardHeader>
        ...
        <Card className="lg:col-span-6">
          <CardHeader>
            ...
            <CardDescription>
              Points, centroids, and assignment transitions.
            </CardDescription>
          </CardHeader>
        ...
        <Card className="lg:col-span-3">
          <CardHeader>
            ...
            <CardDescription>Centroids and cluster summaries.</CardDescription>
          </CardHeader>
